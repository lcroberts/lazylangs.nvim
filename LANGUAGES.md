...
- Additional Plugins:
    - mrcjkb/rustaceanvim
- Notes: Uses your systems rust analyzer so that it is in sync with the
toolchain you are using. It will automatically install rust-analyzer for the
current toolchain if rustup is available.
